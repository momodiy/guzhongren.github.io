...
这一条就够了，在敏捷项目或者大型项目开发中，我们不难避免作出架构变更的操作。如果一次次的变更都没有记录，对于后来的开发者或者维护者都会是灾难。
...
如上所说，在项目架构有重大变更的时候需要做记录。在此需要说一下，对于敏捷宣言其中有一句，`工作的软件高于详尽的文档`， 这句话的意思不是不写文档。所以，必要的文档还是要写的。
